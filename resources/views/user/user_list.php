...
<div class="mb-3">
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <h5 class="mb-3 mb-sm-0 fw-semibold d-flex align-items-center">
            ...
            All Users <span class="badge text-bg-primary rounded-4 py-1 px-2 ms-2" id="count_users"><?= count($users) ?></span>
        </h5>
                ...
                <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small class="d-flex align-items-center">Expire: <?= $u['expire_date'] ?? "9999-12-31" ?></small>
                        </div>
